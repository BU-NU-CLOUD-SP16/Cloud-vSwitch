...
# Author: Shuwen Sun
# Date: March 20, 2016
# Declaration: this script is adopted to generated the shell script to config server
# Dependencies: ca.cert, server.crt, server.key
#
#####################################

#
# To run
# $ sudo bash OpenVPNserver.sh cacert.pem servercert.pem serverkey.pem
#
